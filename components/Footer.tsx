...
const Footer = () => {
    return (
        <div>
            {/* <!--Footer container--> */}
            <footer className="footer footer-center mt-36 p-10 bg-purple" data-aos='fade-up' data-aos-duration='700'>
                <div>
                ...
                <div className="grid grid-flow-col gap-4 ">
                    <h1 className='font-medium 2xl:text-lg text-white'> Built with Typescript, NextJs, AOS, Framer-Motion, daisyUI</h1>
                </div>
                <div>
